...
const SuperAdminDashboard = () => {
  ...
  const globalProducts = [
    {
      sku: "PROD-NEO-841X",
      name: "Quantum Pro Graphics Card",
    ...
    {
      sku: "PROD-VORT-992M",
      name: "Vortex Ergonomic Desk Chair",
      category: "Office",
      price: "$680.00",
      stock: 0,
      platformCount: 1,
      ...
      <div className="min-h-screen w-full bg-[#090b0e] text-gray-100 font-sans antialiased flex selection:bg-blue-500/30 selection:text-blue-200">
        ...
        <main className="flex-grow min-w-0 p-4 md:p-6 lg:p-8 space-y-6 md:space-y-8">
          ...
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-900 pb-5 w-full">
            <div>
              ...
              <p className="text-xs text-gray-400 font-medium mt-0.5">
                Global management across node engines, product logs, and
                e-shops.
              </p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Link
                to="addAdmin"
                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 shadow-[0_4px_15px_rgba(37,99,235,0.2)] text-white active:scale-95 transition-all rounded-xl text-xs font-bold tracking-wide flex items-center gap-2 cursor-pointer"
              >
          ...
          >
            {[
              {
                label: "Aggregate Synced SKU Items",
                val: "65,650",
                sub: "+12.4% scaling",
              ...
              {
                label: "Active Connected Registries",
                val: "14 Platforms",
                sub: "100% gateway up-time",
                icon: "ri-global-line",
                color: "text-purple-400 bg-purple-500/10 border-purple-500/20",
              },
              {
                label: "Processed Predictions",
                val: "142,804",
                sub: "Avg latency 22ms",
                icon: "ri-cpu-line",
                color:
                  "text-emerald-400 bg-emerald-500/10 border-emerald-500/20",
              },
              {
                label: "System Gateway Integrity",
                val: "99.98%",
                sub: "Zero dropped sync hooks",
              ...
              <motion.div
                ...
                className="bg-[#0f1216] border border-gray-800/60 rounded-2xl p-5 shadow-xl flex items-center justify-between group relative overflow-hidden"
              >
                <div className="space-y-1 z-10">
                  ...
                  <span className="text-[10px] text-gray-400 font-medium block tracking-tight">
                    {stat.sub}
                  </span>
                </div>
                <div
                  className={`h-11 w-11 rounded-xl border flex items-center justify-center ${stat.color} z-10 shadow-inner group-hover:scale-110 transition-transform duration-300`}
                >
            ...
            <div className="lg:col-span-5 bg-[#0f1216] border border-gray-800/60 rounded-3xl p-5 shadow-2xl relative overflow-hidden backdrop-blur-md min-h-[460px] flex flex-col justify-between">
              <div className="w-full">
                <header className="flex items-center justify-between border-b border-gray-800/50 pb-4 mb-4">
                  ...
                  <span className="text-[9px] bg-gray-800 border border-gray-700/40 text-gray-400 px-2 py-0.5 rounded font-mono tracking-wide">
                    Registry Array
                  </span>
                </header>
                ...
                <div className="space-y-2.5 max-h-[340px] overflow-y-auto pr-1">
                  {connectedPlatforms.map((shop) => (
                    <div
                      key={shop.id}
                      className="bg-[#090b0e]/60 border border-gray-800/60 rounded-xl p-3.5 flex items-center justify-between hover:border-gray-700/80 transition-all duration-200 group cursor-pointer"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-[10px] text-gray-500 font-medium block font-mono tracking-tight">
                            {shop.type}
                          </span>
                        </div>
                      </div>
                      <div className="text-right flex flex-col items-end gap-1.5">
                        <span className="text-xs font-bold text-gray-200 font-mono">
                          {(shop.productsSynced / 1000).toFixed(1)}k SKUs
                        </span>
                      ...
                      {globalProducts.map((prod, idx) => (
                        ...
                        >
                          <td className="py-3 pl-1 max-w-[200px]">
                            <div className="truncate font-bold text-white tracking-wide group-hover:text-blue-400 transition-colors">
                              {prod.name}
                            </div>
                            <span className="text-[10px] font-mono text-gray-500 block mt-0.5 tracking-tight">
                              {prod.sku}
                            </span>
                          </td>
                          ...
                          <td className="py-3 text-right pr-1 font-mono">
                            {prod.stock > 0 ? (
                              ...
                              <span className="text-red-400 font-bold bg-red-500/10 border border-red-500/20 px-1.5 py-0.5 rounded text-[10px] tracking-wide uppercase">
                                Out
                              </span>
                            )}
                          </td>
