...
import { useUser, useClerk, UserButton } from "@clerk/react-router";
      ...
      <aside className="hidden xl:flex flex-col justify-between w-64 h-screen sticky top-0 bg-[#0f1216] border-r border-gray-800/60 p-6 z-20">
        <div className="space-y-8">
          ...
          <nav className="space-y-1.5">
            ...
            <a
              href="/adminDashboard"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-blue-600/10 text-blue-400 border border-blue-500/20 text-sm font-medium transition-all"
            >
            ...
            >
              <i className="ri-global-line text-lg group-hover:text-blue-400"></i>{" "}
              E-Com Registries
            </a>
            <a
              href="#inventory"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-400 hover:text-white hover:bg-[#15191f] border border-transparent text-sm font-medium transition-all group"
            >
              <i className="ri-archive-stack-line text-lg group-hover:text-blue-400"></i>{" "}
              Master Inventory
            </a>
          </nav>
        </div>
